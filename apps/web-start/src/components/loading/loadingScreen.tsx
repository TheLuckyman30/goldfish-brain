...
export function Loading() {
  return (
    <div
      className="flex justify-center min-h-lvh w-lvw bg-no-repeat bg-cover bg-top"
      style={{
    ...
    >
      ...
      >
        <img
          src={loadingFish}
          alt="Loading"
          className="w-32vh h-32vh md:w-40vh md:h-40vh"
        />

        <div className="typewriter">
          <h1
            style={{ fontSize: '30px', color: 'white', position: 'absolute' }}
          >
            Loading ...
          </h1>
        </div>
