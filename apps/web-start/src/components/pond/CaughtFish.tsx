    ...
    <div>
      <section className="bg-white p-6 rounded-[60px] shadow-md ">
        <section className="overflow-hidden overflow-y-auto h-[35vh]">
          <img
            src={fishArray[caughtFish.imageIndex]}
            alt="Caught Fish"
            className="w-[10vw] h-auto mb-2 rounded-[30px] mx-auto"
          />
          <div className="font-bold text-[#794531fb] mb-2 text-3xl">
            Task Name:
          </div>
          <div className="text-2xl mb-4 text-[#538f97]">
            {caughtFish.task.name}
          </div>

          <div className="font-bold mb-2 text-3xl text-[#794531fb]">
            Task Description:
          </div>
          <div className="text-2xl mb-4 text-[#538f97] h-[5vh] ">
            {caughtFish.task.description}
          </div>
        </section>
