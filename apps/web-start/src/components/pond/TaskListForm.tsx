  ...
  return (
    <Backdrop>
      ...
      <div className="bg-[#538f97] min-w-[70%] min-h-[75%] w-[70%] h-[75%] rounded-[60px] flex items-center flex-col mt-5 " > 
        <div className="text-4xl text-center rounded-md p-10 text-white"> Select A Task List to Play </div>
        ...
        <section className="flex-row flex gap-2">
          <div className="bg-white min-w-[20vw] min-h-[50vh] w-[25vw] h-[56vh] rounded-[60px] mr-5 m-2 p-3 flex items-center flex-col text-blue-600"> 
            <div className=" flex text-3xl text-center justify-center rounded-md p-5 text-[#794531fb]">Lists: </div>
            ...
            {lists.map((list) => (
              ...
              <button className= "min-w-[12vw] w-[18vw] min-h-[6vh] p-1 mb-3 bg-[#794531fb] hover:bg-[#8d4f36ef] duration-100 rounded-[60px] text-[20px] text-white "
              key={list.id} value={JSON.stringify(list)} onClick={(e)=> setSelectedTaskList(JSON.parse(e.currentTarget.value))}>
                {list.name}
              </button>
          ...
          <section className="flex-col flex items-center">              
            ...
            <div className="bg-white min-w-[30vw] min-h-[35vh] w-[35vw] h-[45vh] rounded-[60px] ml-5 m-2 p-3 flex flex-col text-center ">
              <div className=" flex text-3xl text-center items-center justify-center rounded-md p-5 text-[#794531fb]">Preview Tasks: </div>
            ...
            <Button className="bg-white hover:bg-[#794531fb] min-w-[30vw] min-h-[10vh] h-[10vh] rounded-[60px] ml-5 m-2 p-3 flex items-center text-center justify-center text-[#794531fb] hover:text-white duration-200 text-3xl" type="submit" disabled={!taskList || taskListIsFetching} onClick={handleSubmit}>
